package com.azhar.catatanharian;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aplikasi Catatan Project 1");
    ...
    public boolean onOptionItemSelected(MenuItem item){
        ...
        String path = Environment.getExternalStorageDirectory().toString() +"/azhar.catatanharian";
